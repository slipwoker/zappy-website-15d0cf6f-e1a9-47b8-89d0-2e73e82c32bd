document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    const ERROR_MESSAGES = {
      ...
      minlength: (param) => `Minimum ${param} characters required.`
    };
    ...
    function validateField(field) {
      ...
      if (field.hasAttribute('required') && !VALIDATORS.required(value)) {
        ...
        if (!errorMessage && minLength && !VALIDATORS.minlength(value, minLength)) {
          errorMessage = typeof ERROR_MESSAGES.minlength === 'function'
            ? ERROR_MESSAGES.minlength(minLength)
    ...
    contactForm.addEventListener('input', function (e) {
      const field = e.target.closest('input, textarea, select');
      if (field && field.classList.contains('field-invalid') && contactForm.contains(field)) {
        validateField(field);
      }
    });
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '61c7faf7-da94-40ba-b5f4-0047d58d01bb',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '61c7faf7-da94-40ba-b5f4-0047d58d01bb';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '15d0cf6f-e1a9-47b8-89d0-2e73e82c32bd';
